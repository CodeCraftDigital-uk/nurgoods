...
SELECT id, 'manual_review', 'awaiting_fulfilment_preview', 'line_linkage_corrected',
       'Line comparison now reads the store line reference the supplier reports, so this order returns to the normal fulfilment queue.'
FROM fixed;